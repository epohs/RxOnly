...
> [!WARNING]
> If you pull the repo and the database schema ([`schema.sql`](/rxonly/db/schema.sql)) version changes your database will be dropped and recreated, wiping all existing data.
